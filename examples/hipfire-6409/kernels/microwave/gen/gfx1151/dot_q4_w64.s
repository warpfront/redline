...
BB5:
	...
	v_dot4_i32_iu8 v28, v28, v24, v1 neg_lo:[1,0,0]             ; cc16401c 3c06311c
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1) ; bf870091
	v_dot4_i32_iu8 v29, v29, v25, v28 neg_lo:[1,0,0]            ; cc16401d 3c72331d
	v_dot4_i32_iu8 v30, v30, v26, v29 neg_lo:[1,0,0]            ; cc16401e 3c76351e
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1) ; bf8700a1
	v_dot4_i32_iu8 v31, v31, v27, v30 neg_lo:[1,0,0]            ; cc16401f 3c7a371f
	s_waitcnt vmcnt(4)                                          ; bf8913f7
	v_dot4_i32_iu8 v32, v32, v12, v31 neg_lo:[1,0,0]            ; cc164020 3c7e1920
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1) ; bf870091
	v_dot4_i32_iu8 v33, v33, v13, v32 neg_lo:[1,0,0]            ; cc164021 3c821b21
	v_dot4_i32_iu8 v34, v34, v14, v33 neg_lo:[1,0,0]            ; cc164022 3c861d22
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1) ; bf8700a1
	v_dot4_i32_iu8 v35, v35, v15, v34 neg_lo:[1,0,0]            ; cc164023 3c8a1f23
	s_waitcnt vmcnt(2)                                          ; bf890bf7
	v_dot4_i32_iu8 v36, v36, v16, v35 neg_lo:[1,0,0]            ; cc164024 3c8e2124
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1) ; bf870091
	v_dot4_i32_iu8 v37, v37, v17, v36 neg_lo:[1,0,0]            ; cc164025 3c922325
	v_dot4_i32_iu8 v38, v38, v18, v37 neg_lo:[1,0,0]            ; cc164026 3c962526
	s_delay_alu instid0(VALU_DEP_1) | instskip(SKIP_1) | instid1(VALU_DEP_1) ; bf8700a1
	v_dot4_i32_iu8 v39, v39, v19, v38 neg_lo:[1,0,0]            ; cc164027 3c9a2727
	s_waitcnt vmcnt(0)                                          ; bf8903f7
	v_dot4_i32_iu8 v20, v20, v4, v39 neg_lo:[1,0,0]             ; cc164014 3c9e0914
	s_delay_alu instid0(VALU_DEP_1) | instskip(NEXT) | instid1(VALU_DEP_1) ; bf870091
	v_dot4_i32_iu8 v21, v21, v5, v20 neg_lo:[1,0,0]             ; cc164015 3c520b15
	v_dot4_i32_iu8 v22, v22, v6, v21 neg_lo:[1,0,0]             ; cc164016 3c560d16
	s_delay_alu instid0(VALU_DEP_1)                             ; bf870001
	v_dot4_i32_iu8 v1, v23, v7, v22 neg_lo:[1,0,0]              ; cc164001 3c5a0f17
	s_branch BB2                                                ; bfa0ff7b
BB6:
	v_mov_b32_e32 v2, 0                                         ; 7e040280
