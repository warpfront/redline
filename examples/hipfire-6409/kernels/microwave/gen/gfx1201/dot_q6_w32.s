...
BB5:
	...
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_2) | instid1(VALU_DEP_2) ; bf870133
	v_dot4_i32_iu8 v12, v12, v16, v9 neg_lo:[1,0,0]             ; cc16400c 3c26210c
	v_dot4_i32_iu8 v13, v13, v17, v10 neg_lo:[1,0,0]            ; cc16400d 3c2a230d
	v_dot4_i32_iu8 v14, v14, v18, v11 neg_lo:[1,0,0]            ; cc16400e 3c2e250e
	...
	v_dot4_i32_iu8 v16, v23, s8, 0 neg_lo:[1,0,0]               ; cc164010 3a001117
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_4) ; bf870252
	v_lshlrev_b32_e32 v12, 5, v12                               ; 30181885
	v_lshlrev_b32_e32 v16, 5, v16                               ; 30202085
	s_wait_loadcnt 0x2                                          ; bfc00002
	v_dot4_i32_iu8 v17, v28, s8, 0 neg_lo:[1,0,0]               ; cc164011 3a00111c
	v_dot4_i32_iu8 v18, v29, s8, 0 neg_lo:[1,0,0]               ; cc164012 3a00111d
	v_sub_nc_u32_e32 v12, 0, v12                                ; 4c181880
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_3) ; bf8701a3
	v_lshlrev_b32_e32 v17, 5, v17                               ; 30222285
	v_lshlrev_b32_e32 v18, 5, v18                               ; 30242485
	v_dot4_i32_iu8 v15, v15, v19, v12 neg_lo:[1,0,0]            ; cc16400f 3c32270f
	v_dot4_i32_iu8 v19, v30, s8, 0 neg_lo:[1,0,0]               ; cc164013 3a00111e
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_4) | instid1(VALU_DEP_4) ; bf870252
	v_add3_u32 v15, v15, v13, v14                               ; d655000f 043a1b0f
	v_dot4_i32_iu8 v13, v20, s8, 0 neg_lo:[1,0,0]               ; cc16400d 3a001114
	v_dot4_i32_iu8 v14, v21, s8, 0 neg_lo:[1,0,0]               ; cc16400e 3a001115
	...
	v_dot4_i32_iu8 v23, v23, v27, v16 neg_lo:[1,0,0]            ; cc164017 3c423717
	...
	v_dot4_i32_iu8 v20, v20, v24, v13 neg_lo:[1,0,0]            ; cc164014 3c363114
	v_dot4_i32_iu8 v21, v21, v25, v14 neg_lo:[1,0,0]            ; cc164015 3c3a3315
	v_dot4_i32_iu8 v28, v28, v32, v17 neg_lo:[1,0,0]            ; cc16401c 3c46411c
	v_dot4_i32_iu8 v29, v29, v33, v18 neg_lo:[1,0,0]            ; cc16401d 3c4a431d
	s_wait_loadcnt 0x0                                          ; bfc00000
	v_dot4_i32_iu8 v24, v39, s8, 0 neg_lo:[1,0,0]               ; cc164018 3a001127
	s_delay_alu instid0(VALU_DEP_4) | instskip(SKIP_4) | instid1(VALU_DEP_4) ; bf870254
	v_add3_u32 v21, v21, v15, v20                               ; d6550015 04521f15
	v_dot4_i32_iu8 v15, v22, s8, 0 neg_lo:[1,0,0]               ; cc16400f 3a001116
	v_dot4_i32_iu8 v20, v31, s8, 0 neg_lo:[1,0,0]               ; cc164014 3a00111f
	...
	v_dot4_i32_iu8 v30, v30, v34, v19 neg_lo:[1,0,0]            ; cc16401e 3c4e451e
	s_delay_alu instid0(VALU_DEP_3) | instskip(SKIP_1) | instid1(VALU_DEP_2) ; bf870123
	v_sub_nc_u32_e32 v15, 0, v15                                ; 4c1e1e80
	v_sub_nc_u32_e32 v20, 0, v20                                ; 4c282880
	v_dot4_i32_iu8 v22, v22, v26, v15 neg_lo:[1,0,0]            ; cc164016 3c3e3516
	v_dot4_i32_iu8 v31, v31, v35, v20 neg_lo:[1,0,0]            ; cc16401f 3c52471f
	s_delay_alu instid0(VALU_DEP_2) | instskip(SKIP_3) | instid1(VALU_DEP_4) ; bf870242
	v_add3_u32 v23, v23, v21, v22                               ; d6550017 045a2b17
	v_dot4_i32_iu8 v21, v36, s8, 0 neg_lo:[1,0,0]               ; cc164015 3a001124
	v_dot4_i32_iu8 v22, v37, s8, 0 neg_lo:[1,0,0]               ; cc164016 3a001125
	v_sub_nc_u32_e32 v24, 0, v24                                ; 4c303080
	v_add3_u32 v29, v29, v23, v28                               ; d655001d 04722f1d
	v_dot4_i32_iu8 v23, v38, s8, 0 neg_lo:[1,0,0]               ; cc164017 3a001126
	v_lshlrev_b32_e32 v21, 5, v21                               ; 302a2a85
	v_lshlrev_b32_e32 v22, 5, v22                               ; 302c2c85
	v_dot4_i32_iu8 v39, v39, v43, v24 neg_lo:[1,0,0]            ; cc164027 3c625727
	...
	v_dot4_i32_iu8 v36, v36, v40, v21 neg_lo:[1,0,0]            ; cc164024 3c565124
	v_dot4_i32_iu8 v37, v37, v41, v22 neg_lo:[1,0,0]            ; cc164025 3c5a5325
	v_dot4_i32_iu8 v38, v38, v42, v23 neg_lo:[1,0,0]            ; cc164026 3c5e5526
	s_delay_alu instid0(VALU_DEP_2) | instskip(NEXT) | instid1(VALU_DEP_1) ; bf870092
	v_add3_u32 v37, v37, v31, v36                               ; d6550025 04923f25
	v_add3_u32 v1, v39, v37, v38                                ; d6550001 049a4b27
	s_branch BB2                                                ; bfa0ff16
BB6:
	v_mov_b32_e32 v2, 0                                         ; 7e040280
