...
Correctness-gated result: **Redline wins 3/4 rows (75.00%)**.

## Four-way placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 3 | 1 | 0 | 0 | 75.00 | 4 |
| vulkan | 0 | 3 | 0 | 1 | 0.00 | 4 |
| hipgraph | 1 | 0 | 3 | 0 | 25.00 | 4 |
| hip | 0 | 0 | 1 | 3 | 0.00 | 4 |
...
| serial_latency | vulkan | 0 | 1 | 0 | 1 | 2 |
| serial_latency | hipgraph | 1 | 0 | 1 | 0 | 2 |
...
|---|---:|---|---:|---:|
| `serial_latency/vopd/variant=dequant_like,accums=4,n=65536,body=512,wg=64;hip-wave=32` | 2 | hipgraph (+2.37%) | 90.6520 | 88.5560 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 4 | 0 | 0 | 100.00 | 0.8813 | 4 |
| RL / hipgraph | 3 | 1 | 0 | 75.00 | 0.7378 | 4 |
| RL / hip | 4 | 0 | 0 | 100.00 | 0.7137 | 4 |
