...
|---|---:|---:|---:|---:|---:|---:|
| redline | 0 | 3 | 0 | 1 | 0.00 | 4 |
| vulkan | 4 | 0 | 0 | 0 | 100.00 | 4 |
| hipgraph | 0 | 0 | 4 | 0 | 0.00 | 4 |
| hip | 0 | 1 | 0 | 3 | 0.00 | 4 |
...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=64;hip-wave=32` | 4 | vulkan (+35.81%), hip (+7.91%), hipgraph (+7.66%) | 29.3520 | 21.6120 |
| `serial_latency/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=256;hip-wave=32` | 2 | vulkan (+34.54%) | 28.8240 | 21.4240 |
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=64;hip-wave=32` | 2 | vulkan (+31.03%) | 21.5000 | 16.4080 |
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=256;hip-wave=32` | 2 | vulkan (+2.93%) | 17.9760 | 17.4640 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 0 | 4 | 0 | 0.00 | 1.3279 | 4 |
| RL / hipgraph | 3 | 1 | 0 | 75.00 | 0.7482 | 4 |
| RL / hip | 3 | 1 | 0 | 75.00 | 0.6488 | 4 |
