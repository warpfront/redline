...
Correctness-gated result: **Redline wins 0/4 rows (0.00%)**.

## Four-way placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 0 | 2 | 1 | 1 | 0.00 | 4 |
| vulkan | 4 | 0 | 0 | 0 | 100.00 | 4 |
| hipgraph | 0 | 2 | 1 | 1 | 0.00 | 4 |
| hip | 0 | 0 | 2 | 2 | 0.00 | 4 |
...
|---|---|---:|---:|---:|---:|---:|
| serial_latency | redline | 0 | 1 | 0 | 1 | 2 |
| serial_latency | vulkan | 2 | 0 | 0 | 0 | 2 |
| serial_latency | hipgraph | 0 | 1 | 1 | 0 | 2 |
| serial_latency | hip | 0 | 0 | 1 | 1 | 2 |
| independent_throughput | redline | 0 | 1 | 1 | 0 | 2 |
| independent_throughput | vulkan | 2 | 0 | 0 | 0 | 2 |
| independent_throughput | hipgraph | 0 | 1 | 0 | 1 | 2 |
...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=64;hip-wave=32` | 4 | vulkan (+13.11%), hipgraph (+3.09%), hip (+1.24%) | 87.8680 | 77.6840 |
| `serial_latency/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=256;hip-wave=32` | 2 | vulkan (+10.15%) | 86.7840 | 78.7840 |
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=64;hip-wave=32` | 3 | vulkan (+37.74%), hipgraph (+4.01%) | 89.5280 | 64.9960 |
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=256;hip-wave=32` | 2 | vulkan (+44.60%) | 93.5480 | 64.6960 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 0 | 4 | 0 | 0.00 | 1.2543 | 4 |
| RL / hipgraph | 2 | 2 | 0 | 50.00 | 0.8169 | 4 |
| RL / hip | 3 | 1 | 0 | 75.00 | 0.7925 | 4 |
...
This is **not a Hipfire harness failure**: Redline beats direct HIP in 3/4 rows and HipGraph in 2/4 while all three select identical per-row hipcc code objects. This run uses the `hipengine_f2c` matrix, `radiowave_tuned` wave policy, and `default` scheduler profile. Remaining Vulkan-only wins therefore isolate compiler/lowering, kernel scheduling, or unavoidable completion/timestamp costs rather than a missing Redline dispatch path. Redline beats Vulkan pairwise in 0/4 rows, so neither the categorical ‘HIP is inherently slower’ theory nor the categorical ‘it was all hipEngine’ theory survives this control.
