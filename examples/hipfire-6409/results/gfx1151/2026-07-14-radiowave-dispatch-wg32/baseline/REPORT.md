...
Correctness-gated result: **Redline wins 11/16 rows (68.75%)**.

## Placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 11 | 5 | 0 | 0 | 68.75 | 16 |
| vulkan | 5 | 11 | 0 | 0 | 31.25 | 16 |

## Placement by timing mode

| Mode | Backend | 1st | 2nd | 3rd | 4th | N |
|---|---|---:|---:|---:|---:|---:|
| serial_latency | redline | 8 | 0 | 0 | 0 | 8 |
| serial_latency | vulkan | 0 | 8 | 0 | 0 | 8 |
...
|---|---:|---|---:|---:|
| `independent_throughput/dispatch-grid/sweep=count,count=941,grid=1;hip-wave=32` | 2 | vulkan (+98.09%) | 0.0974 | 0.0491 |
| `independent_throughput/dispatch-grid/sweep=grid,count=941,grid=1;hip-wave=32` | 2 | vulkan (+37.92%) | 0.0973 | 0.0705 |
| `independent_throughput/dispatch-grid/sweep=grid,count=941,grid=128;hip-wave=32` | 2 | vulkan (+260.30%) | 0.6586 | 0.1828 |
| `independent_throughput/dispatch-grid/sweep=grid,count=941,grid=1024;hip-wave=32` | 2 | vulkan (+60.18%) | 2.2928 | 1.4314 |
| `independent_throughput/dispatch-grid/sweep=grid,count=941,grid=8192;hip-wave=32` | 2 | vulkan (+5.53%) | 11.9700 | 11.3432 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 11 | 5 | 0 | 68.75 | 0.8245 | 16 |
