...
Correctness-gated result: **Redline wins 2/4 rows (50.00%)**.

## Four-way placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 2 | 2 | 0 | 0 | 50.00 | 4 |
| vulkan | 2 | 2 | 0 | 0 | 50.00 | 4 |
...
|---|---:|---|---:|---:|
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=64;hip-wave=64` | 2 | vulkan (+15.92%) | 30.2615 | 26.1056 |
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=64,wg=256;hip-wave=64` | 2 | vulkan (+12.90%) | 30.0892 | 26.6506 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 2 | 2 | 0 | 50.00 | 1.0622 | 4 |
| RL / hipgraph | 4 | 0 | 0 | 100.00 | 0.7814 | 4 |
| RL / hip | 4 | 0 | 0 | 100.00 | 0.7932 | 4 |
