...
Correctness-gated result: **Redline wins 4/12 rows (33.33%)**.

## Four-way placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 4 | 8 | 0 | 0 | 33.33 | 12 |
| vulkan | 8 | 4 | 0 | 0 | 66.67 | 12 |
...
| independent_throughput | redline | 2 | 2 | 0 | 0 | 4 |
| independent_throughput | vulkan | 2 | 2 | 0 | 0 | 4 |
...
|---|---:|---|---:|---:|
| `serial_latency/vopd/variant=independent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+4.55%) | 9.6137 | 9.1950 |
| `serial_latency/vopd/variant=dependent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+3.17%) | 9.6538 | 9.3575 |
| `serial_latency/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+35.57%) | 22.6762 | 16.7263 |
| `serial_latency/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+40.37%) | 20.5287 | 14.6250 |
| `independent_throughput/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+27.48%) | 9.3075 | 7.3012 |
| `independent_throughput/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+25.73%) | 8.1425 | 6.4763 |
| `single_kernel_aggressive/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+16.33%) | 13.6800 | 11.7600 |
| `single_kernel_aggressive/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+16.79%) | 12.8000 | 10.9600 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 4 | 8 | 0 | 33.33 | 1.1044 | 12 |
| RL / hipgraph | 12 | 0 | 0 | 100.00 | 0.2220 | 12 |
| RL / hip | 12 | 0 | 0 | 100.00 | 0.2658 | 12 |
