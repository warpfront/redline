...
|---|---:|---|---:|---:|
| `serial_latency/vopd/variant=independent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+6.09%) | 9.6062 | 9.0550 |
| `serial_latency/vopd/variant=dependent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+2.95%) | 9.6512 | 9.3750 |
| `serial_latency/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+40.51%) | 22.6400 | 16.1125 |
| `serial_latency/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+38.83%) | 20.5075 | 14.7713 |
| `independent_throughput/vopd/variant=independent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+1.20%) | 7.8100 | 7.7175 |
| `independent_throughput/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+28.21%) | 9.3000 | 7.2538 |
| `independent_throughput/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+26.08%) | 8.1150 | 6.4363 |
| `single_kernel_aggressive/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+21.31%) | 14.1200 | 11.6400 |
...
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 3 | 9 | 0 | 25.00 | 1.1092 | 12 |
| RL / hipgraph | 12 | 0 | 0 | 100.00 | 0.2208 | 12 |
| RL / hip | 12 | 0 | 0 | 100.00 | 0.2653 | 12 |
