...
|---|---:|---|---:|---:|
| `serial_latency/vopd/variant=independent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+5.02%) | 9.6150 | 9.1550 |
| `serial_latency/vopd/variant=dependent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+3.65%) | 9.6600 | 9.3200 |
| `serial_latency/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+36.76%) | 22.0475 | 16.1212 |
| `serial_latency/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+24.40%) | 18.1825 | 14.6163 |
| `independent_throughput/vopd/variant=independent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+2.56%) | 7.8137 | 7.6188 |
| `independent_throughput/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+29.20%) | 9.4300 | 7.2988 |
| `independent_throughput/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+16.06%) | 7.5350 | 6.4925 |
| `single_kernel_aggressive/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=64` | 2 | vulkan (+19.93%) | 14.2000 | 11.8400 |
| `single_kernel_aggressive/vopd/variant=dequant-like,n=32768,body=64;hip-wave=64` | 2 | vulkan (+8.70%) | 12.0000 | 11.0400 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 3 | 9 | 0 | 25.00 | 1.0686 | 12 |
| RL / hipgraph | 12 | 0 | 0 | 100.00 | 0.2182 | 12 |
| RL / hip | 12 | 0 | 0 | 100.00 | 0.2617 | 12 |
