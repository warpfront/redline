...
Correctness-gated result: **Redline wins 1/3 rows (33.33%)**.

## Four-way placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 1 | 2 | 0 | 0 | 33.33 | 3 |
| vulkan | 2 | 1 | 0 | 0 | 66.67 | 3 |
...
| single_kernel_aggressive | redline | 1 | 0 | 0 | 0 | 1 |
| single_kernel_aggressive | vulkan | 0 | 1 | 0 | 0 | 1 |
...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+22.79%) | 23.3875 | 19.0463 |
| `independent_throughput/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+25.60%) | 19.6700 | 15.6613 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 1 | 2 | 0 | 33.33 | 1.2279 | 3 |
| RL / hipgraph | 3 | 0 | 0 | 100.00 | 0.3997 | 3 |
| RL / hip | 3 | 0 | 0 | 100.00 | 0.4648 | 3 |
...
This is **not a Hipfire harness failure**: Redline beats direct HIP in 3/3 rows and HipGraph in 3/3 while all three select identical per-row hipcc code objects. This run uses the `targeted_wave64` wave policy; the aggressive single-kernel mode removes dependency fences from Redline's timed tape. Remaining Vulkan-only wins therefore isolate compiler/lowering, kernel scheduling, or unavoidable completion/timestamp costs rather than a missing Redline dispatch path. Redline beats Vulkan pairwise in 1/3 rows, so neither the categorical ‘HIP is inherently slower’ theory nor the categorical ‘it was all hipEngine’ theory survives this control.
