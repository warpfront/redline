...
|---|---:|---|---:|---:|
| `serial_latency/vopd/variant=independent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+48.80%) | 13.2413 | 8.8987 |
| `serial_latency/vopd/variant=dependent-fma,n=32768,body=64;hip-wave=64` | 2 | vulkan (+24.05%) | 11.2200 | 9.0450 |
| `serial_latency/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=32` | 2 | vulkan (+76.88%) | 27.6038 | 15.6062 |
| `serial_latency/vopd/variant=dequant-like,n=32768,body=64;hip-wave=32` | 2 | vulkan (+62.65%) | 23.6537 | 14.5425 |
| `independent_throughput/vopd/variant=independent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+25.19%) | 9.2637 | 7.4000 |
| `independent_throughput/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=32` | 2 | vulkan (+45.26%) | 10.7925 | 7.4300 |
| `independent_throughput/vopd/variant=dequant-like,n=32768,body=64;hip-wave=32` | 2 | vulkan (+32.08%) | 8.5750 | 6.4925 |
| `single_kernel_aggressive/vopd/variant=independent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+9.71%) | 9.0400 | 8.2400 |
| `single_kernel_aggressive/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=32` | 2 | vulkan (+38.10%) | 16.2400 | 11.7600 |
...
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 2 | 10 | 0 | 16.67 | 1.3191 | 12 |
| RL / hipgraph | 12 | 0 | 0 | 100.00 | 0.2495 | 12 |
| RL / hip | 12 | 0 | 0 | 100.00 | 0.2887 | 12 |
