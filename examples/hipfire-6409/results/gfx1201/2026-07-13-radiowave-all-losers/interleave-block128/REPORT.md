...
Correctness-gated result: **Redline wins 2/6 rows (33.33%)**.

## Four-way placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 2 | 4 | 0 | 0 | 33.33 | 6 |
| vulkan | 4 | 2 | 0 | 0 | 66.67 | 6 |
...
|---|---|---:|---:|---:|---:|---:|
| serial_latency | redline | 0 | 2 | 0 | 0 | 2 |
...
| single_kernel_aggressive | redline | 1 | 1 | 0 | 0 | 2 |
| single_kernel_aggressive | vulkan | 1 | 1 | 0 | 0 | 2 |
...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=interleave4,n=4096,body=16;hip-wave=32` | 2 | vulkan (+28.83%) | 8.0550 | 6.2525 |
| `serial_latency/memory-waitcnt/variant=interleave4,n=32768,body=16;hip-wave=32` | 2 | vulkan (+60.28%) | 16.4612 | 10.2700 |
| `independent_throughput/memory-waitcnt/variant=interleave4,n=32768,body=16;hip-wave=32` | 2 | vulkan (+45.58%) | 10.6875 | 7.3412 |
| `single_kernel_aggressive/memory-waitcnt/variant=interleave4,n=32768,body=16;hip-wave=32` | 2 | vulkan (+2.80%) | 11.7600 | 11.4400 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 2 | 4 | 0 | 33.33 | 1.1581 | 6 |
| RL / hipgraph | 6 | 0 | 0 | 100.00 | 0.4122 | 6 |
| RL / hip | 6 | 0 | 0 | 100.00 | 0.5191 | 6 |
