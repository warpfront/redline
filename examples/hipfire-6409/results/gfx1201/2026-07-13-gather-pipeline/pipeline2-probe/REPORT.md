...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+15.12%) | 22.5325 | 19.5738 |
| `independent_throughput/memory-waitcnt/variant=gather,n=4096,body=16;hip-wave=32` | 2 | vulkan (+56.60%) | 2.3206 | 1.4819 |
| `independent_throughput/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+31.59%) | 19.1812 | 14.5762 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 3 | 3 | 0 | 50.00 | 1.0314 | 6 |
| RL / hipgraph | 6 | 0 | 0 | 100.00 | 0.3828 | 6 |
| RL / hip | 6 | 0 | 0 | 100.00 | 0.4689 | 6 |
