...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+14.11%) | 22.1400 | 19.4025 |
| `independent_throughput/memory-waitcnt/variant=gather,n=4096,body=16;hip-wave=32` | 2 | vulkan (+40.61%) | 2.1900 | 1.5575 |
| `independent_throughput/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+31.69%) | 17.2812 | 13.1225 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 3 | 3 | 0 | 50.00 | 1.0299 | 6 |
| RL / hipgraph | 6 | 0 | 0 | 100.00 | 0.3831 | 6 |
| RL / hip | 6 | 0 | 0 | 100.00 | 0.4771 | 6 |
