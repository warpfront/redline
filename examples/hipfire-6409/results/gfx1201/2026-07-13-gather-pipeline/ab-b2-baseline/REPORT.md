...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+11.65%) | 21.4150 | 19.1800 |
| `independent_throughput/memory-waitcnt/variant=gather,n=4096,body=16;hip-wave=32` | 2 | vulkan (+51.56%) | 2.1550 | 1.4219 |
| `independent_throughput/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+33.87%) | 17.5825 | 13.1337 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 3 | 3 | 0 | 50.00 | 1.0134 | 6 |
| RL / hipgraph | 6 | 0 | 0 | 100.00 | 0.3790 | 6 |
| RL / hip | 6 | 0 | 0 | 100.00 | 0.4726 | 6 |
