...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+11.23%) | 21.6062 | 19.4250 |
| `independent_throughput/memory-waitcnt/variant=gather,n=4096,body=16;hip-wave=32` | 2 | vulkan (+66.88%) | 2.2956 | 1.3756 |
| `independent_throughput/memory-waitcnt/variant=gather,n=32768,body=16;hip-wave=32` | 2 | vulkan (+33.56%) | 17.2037 | 12.8812 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 3 | 3 | 0 | 50.00 | 1.0044 | 6 |
| RL / hipgraph | 6 | 0 | 0 | 100.00 | 0.3811 | 6 |
| RL / hip | 6 | 0 | 0 | 100.00 | 0.4594 | 6 |
