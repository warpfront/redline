...
|---|---:|---|---:|---:|
| `serial_latency/vopd/variant=independent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+15.43%) | 10.0825 | 8.7350 |
| `serial_latency/vopd/variant=dependent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+22.10%) | 11.0988 | 9.0900 |
| `serial_latency/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=32` | 2 | vulkan (+48.88%) | 23.3012 | 15.6512 |
| `serial_latency/vopd/variant=dequant-like,n=32768,body=64;hip-wave=32` | 2 | vulkan (+53.63%) | 21.7188 | 14.1375 |
| `independent_throughput/vopd/variant=independent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+13.59%) | 8.2450 | 7.2588 |
| `independent_throughput/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=32` | 2 | vulkan (+35.16%) | 9.8987 | 7.3238 |
| `independent_throughput/vopd/variant=dequant-like,n=32768,body=64;hip-wave=32` | 2 | vulkan (+34.15%) | 8.7250 | 6.5038 |
| `single_kernel_aggressive/vopd/variant=independent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+0.98%) | 8.2800 | 8.2000 |
| `single_kernel_aggressive/vopd/variant=dependent-fma,n=32768,body=64;hip-wave=32` | 2 | vulkan (+0.48%) | 8.3200 | 8.2800 |
| `single_kernel_aggressive/vopd/variant=mixed-int-float,n=32768,body=64;hip-wave=32` | 2 | vulkan (+26.62%) | 14.8400 | 11.7200 |
| `single_kernel_aggressive/vopd/variant=dequant-like,n=32768,body=64;hip-wave=32` | 2 | vulkan (+25.91%) | 13.8000 | 10.9600 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 1 | 11 | 0 | 8.33 | 1.2401 | 12 |
| RL / hipgraph | 12 | 0 | 0 | 100.00 | 0.2342 | 12 |
| RL / hip | 12 | 0 | 0 | 100.00 | 0.2775 | 12 |
