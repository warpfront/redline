...
|---|---:|---|---:|---:|
| `serial_latency/memory-waitcnt/variant=interleave4,n=32768,body=16;hip-wave=64` | 2 | vulkan (+6.29%) | 10.8600 | 10.2175 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 1 | 1 | 0 | 50.00 | 0.8862 | 2 |
| RL / hipgraph | 2 | 0 | 0 | 100.00 | 0.5954 | 2 |
| RL / hip | 2 | 0 | 0 | 100.00 | 0.5799 | 2 |
