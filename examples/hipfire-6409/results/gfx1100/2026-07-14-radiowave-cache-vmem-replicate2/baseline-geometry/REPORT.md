...
Correctness-gated result: **Redline wins 15/16 rows (93.75%)**.

## Placement table

| Backend | 1st | 2nd | 3rd | 4th | Win % | N |
|---|---:|---:|---:|---:|---:|---:|
| redline | 15 | 1 | 0 | 0 | 93.75 | 16 |
| vulkan | 1 | 15 | 0 | 0 | 6.25 | 16 |
...
| independent_throughput | vulkan | 0 | 8 | 0 | 0 | 8 |

## Redline losses

| Row | RL place | Beaters (RL slower) | RL us/op | Winner us/op |
|---|---:|---|---:|---:|
| `serial_latency/geometry/k=512,rows=1,wg=64,body=32;hip-wave=32` | 2 | vulkan (+11.95%) | 46.6680 | 41.6880 |

## Pairwise Redline results

| Comparison | Wins | Losses | Ties | Win % | Median ratio | N |
|---|---:|---:|---:|---:|---:|---:|
| RL / vulkan | 15 | 1 | 0 | 93.75 | 0.4562 | 16 |
